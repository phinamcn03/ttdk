...
namespace FWS.TTDKGDTS.ImportTool.ServiceReference.Soap
{
    /// <remarks/>
    ...
    public partial class CAssetService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        /// <remarks/>
        public CAssetService()
        {
            string urlSetting = System.Configuration.ConfigurationManager.AppSettings["vtnt.Service.Data"] + "/Asset/AssetService.asmx";
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SendGCN", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string SendGCN(string ClientKey, string InputValue)
        {
            object[] results = this.Invoke("SendGCN", new object[] {
                    ClientKey,
                    InputValue});
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SendReport", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/CheckScanFileExists", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool CheckScanFileExists(string filename)
        {
            object[] results = this.Invoke("CheckScanFileExists", new object[] {
                    filename});
