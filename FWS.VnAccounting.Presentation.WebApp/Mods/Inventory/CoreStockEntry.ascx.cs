...
{
    public partial class CoreStockEntry : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                string scriptServerConfig = CGrid.CreateGridConfig(0, GridID, 1, "colModelInvent_" + InstantID, "colNameInvent_" + InstantID, "optionInvent_" + InstantID);
