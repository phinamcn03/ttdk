<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentEntry.ascx.cs" Inherits="FWS.VnAccounting.Presentation.WebApp.Mods.GeneralLedger.PaymentEntry" %>
<!-- Phiếu chi -->
<div class="easyui-window" title="Phiếu chi" modal="false" style="width: 800px; height: 370px;">
