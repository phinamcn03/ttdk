<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreditedEntry.ascx.cs" Inherits="FWS.VnAccounting.Presentation.WebApp.Mods.GeneralLedger.CreditedEntry" %>
<!-- Giấy báo có -->
<div class="easyui-window" title="Giấy báo có" modal="false" style="width: 800px; height: 370px;">
