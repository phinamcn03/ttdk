<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CashBaseEntry.ascx.cs" Inherits="FWS.VnAccounting.Presentation.WebApp.Mods.CashBanking.CashBaseEntry" %>
...
<div class="border-layout">
    <fieldset class="border-layout-functions"><legend>Chức năng</legend>
        <a href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-save" id="<%=InstantID + "Payment-btnSave"%>">
            Thêm</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-delete" id="<%=InstantID + "Payment-btnDel"%>">
            Xóa</a>
