...
{
    public partial class ChartAccount : CTemplateUserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string scriptServerConfig = CGrid.CreateGridConfig(0, 9, 1, "colModelAccount", "colNameAccount", "optionAccount");
