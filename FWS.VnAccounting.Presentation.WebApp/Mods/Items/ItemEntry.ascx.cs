...
{
    public partial class ItemEntry : CTemplateUserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string scriptServerConfig = CGrid.CreateGridConfig(0, 7, 1, "colModelVendor", "colNameVendor", "optionServerVendor");
