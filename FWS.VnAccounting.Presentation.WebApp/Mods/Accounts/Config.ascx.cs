...
{
    public partial class Config : CTemplateUserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string scriptServerConfig = CGrid.CreateGridConfig(0, 22, 1, "colModelConfig", "colNameConfig", "optionServerConfig");
