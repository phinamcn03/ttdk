...
Mods.CoreHst.Grid[__HstGridID] = {
    ...
    deleteItem: function (option) {
        ...
        var arr = [];
        var obj = {
            filterXml: $.string.Format('<InputValue UserID="{1}"/><RequestParams Function="PhongToa" Action="DELETE" ID="{0}" />', _this.rowSelected.Data.ID, $.cookie('FWS:ACCOUNTING:USER.ID'))
        };
        FWS.System.IO.Ajax({
            url: parent.FWS.Web.Core.URL.ExecuteAction,
