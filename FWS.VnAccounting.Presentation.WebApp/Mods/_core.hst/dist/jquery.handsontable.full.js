...
(function ($, window, Handsontable) {
    ...
    , GridSettings = function () {
      ...
      , _exe = instance.PluginHooks.execute;
        ...
        */
        ...
        /*tainguyen: hide column*/
        this.hideColumn = function (val) {
    ...
    */
    function HandsontableColumnSorting() {
        ...
        this.sort = function () {
            ...
            var sorttype = instance.getSettings().columns[instance.sortColumn].hstsorttype;
            var primer = function (value) {
                var ret = value;
                if (ret != '' && $.isNumeric(ret)) {
                    switch (sorttype) {
                        case 'int':
                            ret = parseInt(value);
                            break;
    ...
    WalkontableScrollbar.prototype.init = function () {
        ...
        this.dragdealer = new Dragdealer(this.slider, {
            ...
            callback: function (x, y) {
                ...
                //tai.nguyen [1] -----------------
                //horizontal bar scroll grid total >> scroll grid data            
                var totalInstance = $($(container).parent()).handsontable('getInstance');
                var settingsTotal = totalInstance.getSettings();
                if (settingsTotal.gridTotal) {
                    var contentInstance = $(settingsTotal.gridContentID).handsontable('getInstance');
                    contentInstance.view.wt.wtScrollbars.horizontal.scrollTo(totalInstance.view.wt.lastOffsetColumn);
    ...
    */
    ...
    WalkontableSettings.prototype.columnWidth = function (column) {
        return Math.min(350, this._getSetting('columnWidth', column));
    };
